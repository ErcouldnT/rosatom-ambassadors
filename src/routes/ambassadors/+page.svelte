<script>
	import { getAmbassadors } from '$lib/services/mockApi';
	import { language } from '$lib/stores/language';
	import { translations } from '$lib/services/translations';
	import { ArrowRight } from '@lucide/svelte';

	$: t = translations[$language].ambassadorsPage;
	...
	<div class="container mx-auto px-6">
		...
		<div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
			{#each ambassadors as ambassador (ambassador.id)}
				<div class="group relative h-[400px] overflow-hidden rounded-2xl bg-base-200 shadow-xl">
					<img
